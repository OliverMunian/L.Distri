...
export default function DetailsPage({ params }) {
    ...
    .map((feature, i) => {
      return (
        <div key={i} className="flex items-center py-2">
          ...
          <h1 className="max-sm:text-xs">{feature.label}</h1>
        </div>
      );
    });
  ...
  return (
    <div className="w-full h-full flex flex-col min-h-screen bg-[#b6b6b6] px-20 max-sm:px-0 max-lg:px-4 max-xl:px-12">
      <div className="w-full flex items-center justify-between border-zinc-300 border-b-[0.75px] pb-5 mb-5 max-md:flex-col">
        <h1 className="font-inter font-semibold text-[#060b1f] text-4xl max-md:text-center">
          Aperçu de votre annonce
        </h1>
        <div className="flex items-center">
          <button
            onClick={() => handleDelete(item._id)}
            className="bg-red-500 text-white mx-2 px-3 py-1 rounded-md text-sm font-inter font-bold hover:bg-red-700 hover:cursor-pointer"
          >
            Supprimer
          </button>
          <button
      ...
      <div className="w-full flex items-start justify-between max-lg:flex-col">
        ...
        <div className="w-2/3 flex flex-col border-b-zinc-300 border-b-[0.75px] pb-10 mb-5 max-lg:w-full">
          <div className="w-full">
            <CarouselTruck
              ...
              design={`rounded-xl`}
              arrows={true}
              size={`w-full h-[500px] object-contain`}
            />
          </div>
          <div className="w-full flex flex-col ">
            ...
            <p className="font-inter text-[#060b1f] font-light text-sm whitespace-pre-line">
        ...
        <div className="w-[30%] flex flex-col max-lg:w-full">
          ...
          <button className="bg-[#1f2937] w-[75%] p-2 rounded-lg mt-5 flex items-center justify-center hover:bg-[#374860] hover:cursor-pointer">
      ...
      {/*OPTIONS DU VEHICULE*/}
      <div className="w-2/3 flex flex-col border-zinc-300 border-b-[0.75px] pb-5 max-md:w-full">
        <div className="w-full flex flex-col my-10">
          <h1 className="font-inter font-semibold text-2xl text-[#060b1f] mb-10">
            Options du vehicule
          </h1>
          <div className="flex gap-12 max-sm:gap-0 max-sm:w-full ">
            <div className="flex flex-col max-sm:w-1/2">
