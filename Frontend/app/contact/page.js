...
export default function Contact() {
  ...
  useEffect(() => {
    if (router.isReady) {
      ...
      if (brand && model && serialNumber) {
        ...
        console.log(
          "Les paramètres brand, model et serialNumber sont manquants."
        );
      }
    }
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col justify-between">
      ...
      <div className="w-full flex items-start justify-center px-5 max-xl:flex-col-reverse">
        <div className="w-[35%] flex flex-col py-12 items-center max-xl:w-full">
          <div className="w-full flex flex-col items-center justify-center">
            <div className="flex items-center max-xl:items-start">
              <FaMapLocationDot className="text-base text-[#060b1f] mx-2" />
              <h1 className="font-inter text-[#060b1f] text-center ">
                Retrouvez-nous à l'adresse suivante:
              </h1>
            </div>
            <p className=" font-inter text-[#060b1f] text-center">
              Zone Artisanal de Lann Borne, 14, 56450 Surzur, France{" "}
            </p>
            <br />
            <p className=" font-inter text-[#060b1f] text-center">
            ...
            <br />
            <p className=" font-inter text-[#060b1f] text-center">Lun-Ven:</p>
            <p className=" font-inter text-[#060b1f] text-center">
        ...
        <main className="flex flex-col items-center justify-center px-5 py-12 max-w-3xl  w-full">
